...
vlog -reportprogress 300 -work work pcctl.sv
vlog -reportprogress 300 -work work regfile.sv 
# —suppress 7061 regfile.sv
vlog -reportprogress 300 -work work ctl.sv
vlog -reportprogress 300 -work work ictl.sv
vlog -reportprogress 300 -work work jctl.sv
